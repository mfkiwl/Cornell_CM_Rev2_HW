 ...
 * Timestamp:                                          2022-11-15 18:44:54 GMT-05:00
 *
 ...
 * Project File:       D:\6089-119_CM_2xVU13P\GitHub\Cornell_CM_Rev2_HW\ClockBuilderPRO\projects\Si5395-RevA-R1Av0005-Project.slabtimeproj
 * Design ID:          R1Av0005
 * Created By:         ClockBuilder Pro v4.1 [2021-09-22]
 * Timestamp:          2022-11-15 18:44:54 GMT-05:00
 * 
 * Design Notes
 * ============
 * Synthesizer R1A for Apollo CMv2, 6089-119-RevA, schematic sheet 2.09
 * v0005: Use ATCA clock at input IN_0 for 320.63 MHz on all outputs, also zero delay mode
 * 
 * Design Rule Check
 * =================
 * Errors:
 ...
 * 
 * Fvco = 14.10772 GHz
 * Fpfd = 1.9432121212121212... MHz [ 1 + 15563/16500 MHz ]
 * Fms0 = 641.26 MHz
 * Fms1 = 641.26 MHz
 * 
 * P dividers:
 ...
 *    Pxaxb = 1
 * 
 * MXAXB = 293.9108333333333333... [ 293 + 1093/1200 ]
 * M = 1452
 * N dividers:
 *    N0 (Zero Delay):
 *       Value: 22
 *       OUT9: 320.63 MHz [ 320 + 63/100 MHz ]
 *       OUT9A: 320.63 MHz [ 320 + 63/100 MHz ]
 *    N1:
 *       Value: 22
 *       OUT0: 320.63 MHz [ 320 + 63/100 MHz ]
 *       OUT1: 320.63 MHz [ 320 + 63/100 MHz ]
 *       OUT2: 320.63 MHz [ 320 + 63/100 MHz ]
 *       OUT3: 320.63 MHz [ 320 + 63/100 MHz ]
 *       OUT4: 320.63 MHz [ 320 + 63/100 MHz ]
 *       OUT5: 320.63 MHz [ 320 + 63/100 MHz ]
 *       OUT6: 320.63 MHz [ 320 + 63/100 MHz ]
 *       OUT7: 320.63 MHz [ 320 + 63/100 MHz ]
 *       OUT8: 320.63 MHz [ 320 + 63/100 MHz ]
 *    N2:
 *       Unused
 *    N3:
 *       Unused
 ...
 * Airflow:  2 m/s
 * 
 * Total Power: 982 mW, On Chip Power: 916 mW, Tj: 42 °C
 * 
 *          Frequency  Format   Voltage   Current     Power
 *         ----------  ------  --------  --------  --------
 * VDD                            1.8 V  152.9 mA    275 mW
 * VDDA                           3.3 V  115.6 mA    381 mW
 * VDDO0A      Unused                                      
 * VDDO0   320.63 MHz  LVDS       1.8 V   16.4 mA     30 mW
 * VDDO1   320.63 MHz  LVDS       1.8 V   16.4 mA     30 mW
 * VDDO2   320.63 MHz  LVDS       1.8 V   16.4 mA     30 mW
 * VDDO3   320.63 MHz  LVDS       1.8 V   16.4 mA     30 mW
 * VDDO4   320.63 MHz  LVDS       1.8 V   16.4 mA     30 mW
 * VDDO5   320.63 MHz  LVDS       1.8 V   16.4 mA     30 mW
 * VDDO6   320.63 MHz  LVDS       1.8 V   16.4 mA     30 mW
 * VDDO7   320.63 MHz  LVDS       1.8 V   16.4 mA     30 mW
 * VDDO8   320.63 MHz  LVDS       1.8 V   16.4 mA     30 mW
 * VDDO9   320.63 MHz  LVDS       1.8 V   16.4 mA     30 mW
 * VDDO9A  320.63 MHz  LVDS       1.8 V   16.4 mA     30 mW
 *                                       --------  --------
 *                                Total  449.3 mA    982 mW
 * 
 * Note:
 * 
 ...
 * 0x005A[25:0]  OOF0_RATIO_REF              14008538           0x0D5C0DA        
 ...
 * 0x00A9[28:0]  LOL_CLR_DELAY_DIV256        25022              0x000061BE       
 ...
 * 0x0235[43:0]  MXAXB_NUM                   739650830336       0x0AC36A00000    
 * 0x023B[31:0]  MXAXB_DEN                   2516582400         0x96000000       
 ...
 * 0x0515[55:0]  M_NUM                       3118146256896      0x0002D600000000 
 ...
 * 0x058B[19:0]  HSW_MEAS_SETTLE             24146              0x05E52          
 ...
 * 0x05AD[15:0]  OUT_MAX_LIMIT_LMT           19261              0x4B3D           
 * 0x05B1[15:0]  HOLD_SETTLE_TARGET          788                0x0314           
