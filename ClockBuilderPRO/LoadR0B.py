...
parser.add_option('--RegisterList', dest="Reg_List", default=dir+'/Si5395-RevA-R0Bv0001-Registers.h',help='Base path of Register List.')
parser.add_option('--DefaultList', dest="Def_List", default=dir+'/Si5395-RevA-default-Registers.h',help='Base path of Default Register List.')
...
LoadClock(PreambleList, RegisterList, PostambleList, DefaultList, not o.Quiet)
